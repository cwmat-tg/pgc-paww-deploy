export class UserMessages {
    ...
    public static PoachingPopup: string = 'The illegal shooting or taking of big game or protected, endangered or threatened species, or any crime against those species should be reported through Operation Game Thief (1-888-PGC-8001) https://www.pgc.pa.gov/HuntTrap/Law/Pages/OperationGameThief.aspx';
}
